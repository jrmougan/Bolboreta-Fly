  ...
  return (
    <div className="politicadeprivacidad">
      ...
      <p>
        ...
        <strong> Bolboreta Flight </strong> usa y protege la información que es
        proporcionada por sus usuarios al momento de utilizar este sitio web.
      ...
      <strong> Bolboreta Flight </strong> está altamente comprometido para
      ...
      <p>
        ...
        <strong> Bolboreta Flight </strong> Se reserva el derecho de cambiar los
